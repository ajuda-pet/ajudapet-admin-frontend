...
import SignupFormGroup5 from "./SignupFormGroup5"
        ...
        <>
            ...
            <center>
                <h4 className='mt-5 mb-4'> Cadastro - &nbsp;
                    ...
                    {step == 4 && <Badge bg='primary'>Seu Login</Badge>}
                    {step == 5 && <Badge bg='primary'>Aguarde</Badge>}
                </h4>
            </center>
            ...
            <Container className='my-4 mt-5'>
                ...
                {step == 4 && <SignupFormGroup1 next={handleNextStep} previus={handlePreviusStep} signupForm={signupForm}></SignupFormGroup1>}
                {step == 5 && <SignupFormGroup5 next={handleNextStep} previus={handlePreviusStep} signupForm={signupForm}></SignupFormGroup5>}
